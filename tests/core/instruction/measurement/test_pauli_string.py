...
def test_to_other_language_braket(
    ...
    assert (
        pauli_strings[
            None
        ]().to_other_language(  # pyright: ignore[reportAttributeAccessIssue, reportOperatorIssue]
            Language.BRAKET
        )
...
def test_rearrange(ps: PauliString, targets: list[int], expected: PauliString):
