...
class Depolarizing(DimensionalNoiseModel):
    ...
    Examples:
        ...
        T  : │                        0                         │
              ┌───┐ ┌────────────┐ ┌────────────┐
        q0 : ─┤ H ├─┤ DEPO(0.32) ├─┤ DEPO(0.01) ├────────────────
              └───┘ └────────────┘ └────────────┘
              ┌───┐ ┌────────────┐ ┌────────────┐
        q1 : ─┤ H ├─┤ DEPO(0.32) ├─┤ DEPO(0.01) ├────────────────
              └───┘ └────────────┘ └────────────┘
              ┌───┐ ┌────────────┐ ┌────────────┐ ┌────────────┐
        q2 : ─┤ H ├─┤ DEPO(0.32) ├─┤ DEPO(0.01) ├─┤ DEPO(0.12) ├─
              └───┘ └────────────┘ └────────────┘ └────────────┘
        T  : │                        0                         │
        >>> print(circuit.to_other_language(Language.CIRQ)) # doctest: +NORMALIZE_WHITESPACE +CIRQ
        q_0: ───I───H───D(0.32)───D(0.01)─────────────
        q_1: ───I───H───D(0.32)───D(0.01)─────────────
        q_2: ───I───H───D(0.32)───D(0.01)───D(0.12)───
...
class AmplitudeDamping(NoiseModel):
    ...
    Examples:
        ...
        T  : │                            0                             │
              ┌───┐  ┌────────────┐  ┌─────────┐ ┌─────────┐ ┌─────────┐
        q0 : ─┤ H ├──┤ GAD(0.2,0) ├──┤ AD(0.1) ├─┤ AD(0.1) ├─┤ AD(0.7) ├─
              └───┘  └────────────┘  └─────────┘ └─────────┘ └─────────┘
              ┌───┐ ┌──────────────┐ ┌─────────┐ ┌─────────┐ ┌─────────┐
        q1 : ─┤ H ├─┤ GAD(0.4,0.1) ├─┤ AD(0.1) ├─┤ AD(0.1) ├─┤ AD(0.7) ├─
              └───┘ └──────────────┘ └─────────┘ └─────────┘ └─────────┘
              ┌───┐ ┌──────────────┐ ┌─────────┐ ┌─────────┐
        q2 : ─┤ H ├─┤ GAD(0.4,0.1) ├─┤ AD(0.1) ├─┤ AD(0.1) ├─────────────
              └───┘ └──────────────┘ └─────────┘ └─────────┘
        T  : │                            0                             │
        >>> print(circuit.to_other_language(Language.CIRQ)) # doctest: +NORMALIZE_WHITESPACE +CIRQ
        q_0: ───I───H───GAD(0,0.2)─────AD(0.1)───AD(0.1)───AD(0.7)───
        q_1: ───I───H───GAD(0.1,0.4)───AD(0.1)───AD(0.1)───AD(0.7)───
        q_2: ───I───H───GAD(0.1,0.4)───AD(0.1)───AD(0.1)─────────────
...
class PhaseDamping(NoiseModel):
    ...
    Examples:
        ...
        T  : │                     0                      │
              ┌───┐ ┌──────────┐ ┌──────────┐ ┌──────────┐
        q0 : ─┤ H ├─┤ PD(0.32) ├─┤ PD(0.01) ├─┤ PD(0.45) ├─
              └───┘ └──────────┘ └──────────┘ └──────────┘
              ┌───┐ ┌──────────┐ ┌──────────┐ ┌──────────┐
        q1 : ─┤ H ├─┤ PD(0.32) ├─┤ PD(0.01) ├─┤ PD(0.45) ├─
              └───┘ └──────────┘ └──────────┘ └──────────┘
              ┌───┐ ┌──────────┐ ┌──────────┐
        q2 : ─┤ H ├─┤ PD(0.32) ├─┤ PD(0.01) ├──────────────
              └───┘ └──────────┘ └──────────┘
        T  : │                     0                      │
        >>> print(circuit.to_other_language(Language.CIRQ)) # doctest: +NORMALIZE_WHITESPACE +CIRQ
        q_0: ───I───H───PD(0.32)───PD(0.01)───PD(0.45)───
        q_1: ───I───H───PD(0.32)───PD(0.01)───PD(0.45)───
        q_2: ───I───H───PD(0.32)───PD(0.01)──────────────
