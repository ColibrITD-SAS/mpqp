...
def rand_orthogonal_matrix(
    ...
    Examples:
        ...
        array(  [[0.3893506, 0.8778771, 0.2788152],
                [0.9076824, -0.417142, 0.0458826],
                [-0.1565849, -0.2352112, 0.9592481]])

        >>> pprint(rand_orthogonal_matrix(3, seed=123))
        array(  [[0.7528597, -0.6578214, 0.0217529],
...
def rand_clifford_matrix(
    ...
    Examples:
        ...
        array(  [[0.5j, -0.5j, 0.5j, -0.5j],
                [-0.5j, -0.5j, -0.5j, -0.5j],
                [-0.5, 0.5, 0.5, -0.5],
                [0.5, 0.5, -0.5, -0.5]])

        >>> pprint(rand_clifford_matrix(2, seed=123))
        array(  [[0.7071068j, 0, -0.7071068j, 0],
...
def rand_unitary_2x2_matrix(
    ...
    Examples:
        ...
        array([[-0.5652968, -0.1048507+0.8181967j],[0.1048507-0.8181967j, 0.0037054-0.5652846j]])

        >>> pprint(rand_unitary_2x2_matrix(seed=123))
        array([[-0.5420506, -0.1555982-0.825815j],[0.1555982+0.825815j, 0.0820389-0.5358063j]])
...
def rand_product_local_unitaries(
    ...
    Example:
        ...
        array(  [[-0.2849254, -0.0419099-0.8909886j, 0.0838011+0.0662151j, -0.1947344+0.2717935j],
                [0.0419099+0.8909886j, -0.2090245+0.1936266j, 0.1947344-0.2717935j, 0.1064752-0.0083725j],
                [-0.0838011-0.0662151j, 0.1947344-0.2717935j, -0.2452949+0.1449584j, -0.489379-0.7457382j],
                [-0.1947344+0.2717935j, -0.1064752+0.0083725j, 0.489379+0.7457382j, -0.0814418+0.273038j]])

        >>> pprint(rand_product_local_unitaries(2, seed=123))
        array(  [[-0.4536362, 0.1128447-0.2744066j, -0.1302185-0.6911157j, 0.4504516+0.0931494j],
...
def rand_hermitian_matrix(
    ...
    Example:
        ...
        array(  [[0.1868666, 0.9327145],
                [0.9327145, 1.6694036]], dtype=complex64)

        >>> pprint(rand_hermitian_matrix(2, seed=123))
        array(  [[1.3647038, 0.2741809],
                [0.2741809, 0.3687436]], dtype=complex64)
